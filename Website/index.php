...
<head>
    ...
    <title>Home | The Sparkles Shop</title>
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-4 col-sm-4">
                            <div class="header-logo">
                                <a href="index.html">
                                    <img src="assets/images/menu/logo/logo.png" alt="Hiraola's Header Logo">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="lsd col-lg-3 col-md-8 col-sm-8">
                            <div class="header-right_area">
                                <ul>
                                    <!-- <li>
                                        <a href="dashboard/login.php" class="wishlist-btn">
                ...
                <div class="single-slide animation-style-01 bg-4">
                    <div class="container">
                        <div class="slider-content">
                            ...
                            <h4>Starting at <span>PKR1599.00</span></h4>
                ...
                <div class="single-slide animation-style-02 bg-5">
                    <div class="container">
                        <div class="slider-content">
                            ...
                            <h2>Phantom4</h2>
                            <h3>Pro+ Obsidian</h3>
                            <h4>Starting at <span>PKR809.00</span></h4>
                            <div class="hiraola-btn-ps_center slide-btn">
                                <a class="hiraola-btn" href="shop-left-sidebar.html">Shopping Now</a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="shipping-item">
                                ...
                                <div class="shipping-content">
                                    <h6>Free PK Standard Delivery</h6>
                                ...
                                <div class="hiraola-product-tab_slider-2">
                                    ...
                                    <div class="slide-item">
                                        <div class="single_product">
                                            ...
                                            <div class="hiraola-product_content">
                                                <div class="product-desc_info">
                                                    <h6><a class="product-name" href="single-product.html">mmmm</a></h6>
                                                    <div class="price-box">
                                                        <span class="new-price">0000</span>
                                                    </div>
                                                    <div class="additional-add_action">
                                                        <ul>
                                                            <li><a class="hiraola-add_compare" href="wishlist.html" data-bs-toggle="tooltip" data-placement="top" title="Add To Wishlist"><i
